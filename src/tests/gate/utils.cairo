pub mod gate_utils {
    ...
    pub fn gate_deploy(
        ...
        IGateDispatcher { contract_address: gate_addr }
    }
    ...
    pub fn eth_gate_deploy(
        ...
        let gate: IGateDispatcher = gate_deploy(eth, shrine.contract_address, common::MOCK_SENTINEL, Option::None);
        (shrine, common::erc20(eth), gate)
    }
    ...
    pub fn wbtc_gate_deploy(
        ...
        let gate: IGateDispatcher = gate_deploy(wbtc, shrine.contract_address, common::MOCK_SENTINEL, Option::None);
        (shrine, common::erc20(wbtc), gate)
    }
